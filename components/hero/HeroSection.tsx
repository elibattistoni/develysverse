...
export default function HeroSection() {
  ...
  return (
    <section ref={sectionRef} style={{ position: "relative", minHeight: "100vh", background: "#080012", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      <motion.div style={{ position: "relative", zIndex: 5, flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: isMobile ? "64px 24px 48px" : "64px 32px 48px 12%", maxWidth: 750, y: textY, opacity: textOpacity }}>
      ...
      <motion.button
        ...
        style={{ position: "absolute", bottom: 48, left: "50%", x: "-50%", zIndex: 5, background: "none", border: "none", cursor: "pointer", padding: 8, width: 24, opacity: cometOpacity }}
      >
